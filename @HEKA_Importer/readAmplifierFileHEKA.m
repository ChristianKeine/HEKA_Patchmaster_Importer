function [Tree, Position, Counter, nchild]=readAmplifierFileHEKA(obj,fh, Tree, Sizes, Level, Position, Counter)
%--------------------------------------------------------------------------
% Gets one record of the tree and the number of children



[s, Counter]=getOneAmplifierRecord(fh, Level, Counter);
...
%--------------------------------------------------------------------------
function [rec, Counter]=getOneAmplifierRecord(fh, Level, Counter)
%--------------------------------------------------------------------------
% Gets one record
Counter=Counter+1;
switch Level
	case 0
		rec=getAmplifierRootRecord(fh);
	case 1
		rec=getAmplifierSeriesRecord(fh);
	case 2
		rec=getAmplifierStateRecord(fh);
